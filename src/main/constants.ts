...
const dogcordDir = dirname(process.execPath);

export const PORTABLE =
    process.platform === "win32" &&
    !process.execPath.toLowerCase().endsWith("electron.exe") &&
    !existsSync(join(dogcordDir, "Uninstall DogCord.exe"));

export const DATA_DIR =
    process.env.DOGPACK_USER_DATA_DIR || (PORTABLE ? join(dogcordDir, "Data") : join(app.getPath("userData")));
...
export const USER_AGENT = `DogCord/${app.getVersion()} (https://github.com/DogPack/DogCord)`;
